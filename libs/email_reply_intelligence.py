...
def build_reply_extraction_prompt(
    *,
    ...
    if lang == "pl":
        return (
            "Jesteś asystentem B2B ds. materiałów budowlanych. Analizuj TYLKO odpowiedź dostawcy "
            "(bez cytowanego naszego zapytania).\n"
            f"Od: {from_email}\nTemat: {subject}\n\n"
            "Odpowiedz WYŁĄCZNIE JSON:\n"
            '{"classification":"offer_with_price|questions|acknowledgment_no_price|auto_reply|bounce",'
            '"confidence":0.85,"routes":[],"questions":[],"needs_human_review":false,"price_evidence":""}\n'
            "Zasady: ignoruj dane rejestrowe (KRS, NIP, REGON). Nie wymyślaj cen. "
            "Gdy jest cena/oferta — offer_with_price. Gdy tylko pytania — questions. "
            "Bez ceny — acknowledgment_no_price.\n\n"
            f"TREŚĆ ODPOWIEDZI:\n{body_clean[:10000]}\n\n"
