# -*- coding: utf-8 -*-
"""Claude: spersonalizowane zapytania mailowe PL (polski) per firma."""
...
from pl_materialy_inquiry_email_pl import ensure_inquiry_contact_in_body
...
from pl_regional_sender_context import resolve_discovery_wojewodztwo, wojewodztwo_primary_city_pl
...
def claude_generate_inquiry_email_pl(
    ...
    *,
    ...
    if not supplier_city:
        supplier_city = wojewodztwo_primary_city_pl(region_key) if region_key else ""
    ...
    prompt = build_personalized_inquiry_email_prompt_pl(
        ...
        discovery_wojewodztwo=ctx["discovery_bundesland"],
    ...
    try:
        ...
        mail_cache[key] = {
            ...
            "body": body,
            "model": model,
            "construction_project": project.name_pl,
