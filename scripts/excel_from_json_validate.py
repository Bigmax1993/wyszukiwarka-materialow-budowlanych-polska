...
NEEDED_JSON_TO_EXCEL = (
    ("company_name_clean", "Nazwa firmy"),
    ("company_name", "Nazwa firmy"),
    ("company_name_raw", "Nazwa firmy"),
    ("full_address", "Adres"),
    ("phones_found", "Telefon"),
    ("email_target", "E-mail"),
    ("official_website", "Strona www"),
    ("bundesland", "Województwo"),
    ("discovery_bundesland", "Województwo"),
    ("retail_chains_found", "Kategorie_materialow"),
    ("email_status", "Status"),
)
...
def verify_and_fill_until_complete(
    ...
    *,
    ...
    """Petla: weryfikacja calego Excela → JSON → uzupelnienie → zapis w pamieci."""
    rounds = 0
